...
class Exp(BaseExp):
    def __init__(self, args={}):
        ...
        self.exp_name = "moco"
        self.save_folder_name = "moco_vit_tiny_imnet_pretrain"
    ...
    def get_data_loader(self, train=True) -> DataLoader:
        if train:
            if "train_dataloader" not in self.__dict__:
                ...
                dataset = ImageNet((self.img_size, self.img_size), transform_k=transform_k, root=self.data_root, memory_cache=self.memory_cache)
